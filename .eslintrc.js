module.exports = {
  ...
  rules: {
    ...
    'jsx-a11y/no-autofocus': 'warn', // Warn instead of error for form autofocus
    ...
    'no-param-reassign': [
      'error',
      {
        ...
        ignorePropertyModificationsFor: [
          ...
          'material', // for Three.js materials
          'object', // for Three.js objects
        ],
      },
    ],
    'prefer-const': [
    ...
    // Error Boundary specific patterns
