...
const ComplementaryColorApp = React.lazy(
...
const RoadBuilderPuzzleApp = React.lazy(
  () => import('./05-road-builder-puzzle/RoadBuilderPuzzleApp')
);
  ...
  const apps = [
    {
      ...
      description:
        'Complete enterprise-grade task management with Firebase backend, real-time collaboration, drag-and-drop kanban boards, user authentication, and project management.',
      icon: (
    ...
    },
    {
      ...
      description:
        'Create 3D artwork with Three.js, featuring brush tools and real-time rendering.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
            strokeLinecap="round"
    ...
    <div className="liquid-library-container">
      ...
      <div className="liquid-side-panel">
        <LiquidGlassCard className="liquid-side-panel-card">
          ...
          <LiquidGlassButton
            onClick={() =>
              window.open('https://github.com/Ovidiu-Puscas/react-portfolio', '_blank')
            }
            className="liquid-app-nav-button"
