  ...
  <div className="connection-editor">
    <div className="editor-header">
      ...
      <div className="editor-controls">
        <Button onClick={exportConnections} variant="primary" icon="💾">
          Export JSON
        </Button>
        <Button onClick={resetConnections} variant="secondary" icon="🔄">
          Reset
        </Button>
      </div>
    </div>
              ...
              <div key={side} className="side-connections">
                ...
                <div className="connection-tiles">
                  {getAllTileTypes().map((targetTile) => (
                    <label key={targetTile} className="connection-option">
                      <input
                        type="checkbox"
                        checked={
                          selectedTileType &&
                          editableConnections[selectedTileType] &&
                          editableConnections[selectedTileType][side]
                            ? editableConnections[selectedTileType][side].includes(targetTile)
                            : false
                        }
