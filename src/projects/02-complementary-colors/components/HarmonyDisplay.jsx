...
const HarmonyDisplay = ({ colors, harmonyType }) => {
  ...
  const getHarmonyDescription = (type) => {
    switch (type) {
      case 'complementary':
        return 'Two colors opposite each other on the color wheel';
      case 'monochromatic':
      ...
      case 'square':
        return 'Four colors forming a square on the color wheel';
      default:
        return '';
    }
  };
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      <p className="text-sm text-gray-600 mb-4">{getHarmonyDescription(harmonyType)}</p>
