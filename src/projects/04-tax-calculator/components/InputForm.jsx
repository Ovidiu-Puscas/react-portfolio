...
const InputForm = ({
  ...
  return (
    <div className="input-group">
      ...
      <div className="input-item">
        <label htmlFor="usdToRonRate" className="block text-gray-700 text-sm font-bold mb-2">
          ...
          {lastUpdated && !apiError && (
            <span className="text-green-600 text-xs ml-2">(Live)</span>
          )}
          {apiError && (
            <span className="text-orange-600 text-xs ml-2">(Default)</span>
          )}
        </label>
        <input
          type="number"
      ...
      <div className="input-item">
        <label htmlFor="nextYearDividendTaxRate" className="block text-gray-700 text-sm font-bold mb-2">
          2026 Dividend <br />
          Tax Rate (%):
        </label>
        <input
