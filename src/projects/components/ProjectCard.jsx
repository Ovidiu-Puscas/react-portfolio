    ...
    <div className="group h-full">
      ...
      >
        ...
        <div className="relative p-6 text-white flex flex-col h-full">
          ...
          {/* Title */}
          <div className="mb-3">
            <Title title={{ heading: 'h3', text: title, class: 'text-xl font-bold text-white leading-tight' }} />
          </div>
          
          {/* Description - flexible height */}
          <div className="flex-grow flex items-start">
            <Description description={{ text: description, class: 'text-white/85 text-sm leading-relaxed line-clamp-3' }} />
          </div>
